                        ...
                        <div className="modal-dialog">
                            ...
                            {/* modal header */}
                                ...
                                <div className="modal-body">
                                    ...
                                    ISBN Buku
                                    <input type="text" className="form-control mb-2" value={this.state.isbn} onChange={ ev => this.setState({isbn:ev.target.value}) } readOnly />
                                    Judul Buku
                                    <input type="text" className="form-control mb-2" placeholder="Masukkan Judul Buku" value={this.state.judul} onChange={ ev => this.setState({judul:ev.target.value}) } required />
                                    Penulis Buku
                                    <input type="text" className="form-control mb-2" placeholder="Masukkan Nama Penulis" value={this.state.penulis} onChange={ ev => this.setState({penulis : ev.target.value}) } required />
                                    Penerbit Buku
                                    <input type="text" className="form-control mb-2" placeholder="Masukkan Nama Penerbit" value={this.state.penerbit} onChange={ ev => this.setState({penerbit: ev.target.value}) } required />
                                    Harga Buku
